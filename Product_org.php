...
<table cellpadding="0" cellspacing="0" border="0">
<tr>
<td height="24"  ><input type="button" class="submit-btn" name="SpProductSmt" Id="SpProductSmt" class="submit-btn" value="Add Specification" class="submit-btn"  onclick="AddSpProduct();"/></td>
<td>&nbsp;</td>
<td height="24" ><input type="button"  class="submit-btn" class="btn_b" value="Reset" onclick="SpProductReset();" /></td>
</tr>
</table>
</td>
</tr>
