...
?>
<input type="text" name="PDScode" id="PDScode" class="input" <?php $_REQUEST['action'] = (isset($_REQUEST['action']) ? $_REQUEST['action'] : ''); if($_REQUEST['action']=='view'){ ?> readonly <?php } ?> value="<?php if($_REQUEST['action']=='view' || $_REQUEST['action']=='edit') echo $autoCode; else echo $autoCode; ?>" autocomplete="off"/>
</td>
</tr>
<tr>
