                ...
                <td align="left" valign="top" class="tdmsg"><table width="100%" border="0" cellspacing="0" cellpadding="0" >
                  <tr>
					...
					while($Register_Fetch=db_fetch_array($Register_Result))
					{
						$id=$Register_Fetch['0']; 
						$startdata=$_REQUEST['startdata']; ?>
					  <tr id="tr_<?php if(isset($id) && !empty($id)) echo $id ?>" <?php if(isset($optId) && !empty($optId)) if ($id == $optId) echo 'style="font-weight:bold; color: orange;"'; 
					...
					<?php $Sno++;
                     ...
                     if($Register_Result_count==0){ ?>
                      <tr><td colspan="6" align="center" class="gridtxt1" style="color:#FFFFFF">No Record Found</td></tr>
                    <?php } ?>
                    <tr>
