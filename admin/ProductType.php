...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
<tr><td colspan="3" align="center"><span id="msgdisplay">&nbsp;<span id="Req"><?php $_REQUEST['s'] = (isset($_REQUEST['s']) ? $_REQUEST['s'] : '');
...
$Fetch['ProductType_Code'] = (isset($Fetch['ProductType_Code']) ? $Fetch['ProductType_Code'] : '');
...
Product Type</td>
<td height="24" align="center"><span class="feildstxt">:</span></td>
<td height="24" align="left"><input name="TxtProdtypeName" type="text" id="TxtProdtypeName" autocomplete="off"  value="<?php $Fetch['ProductType_Name'] = (isset($Fetch['ProductType_Name']) ? $Fetch['ProductType_Name'] : ''); echo $Fetch['ProductType_Name'] ?>" <?php if($_REQUEST['action']=='view' ){ ?> readonly="" <?php } ?> class="input" /></td>
</tr>
<tr>
<td height="24" align="right" class="feildstxt">Product Type Description</td>
<td height="24" align="center"><span class="feildstxt">:</span></td>
<td height="24" align="left" colspan="5"><textarea name="TxtDesc" id="TxtDesc" <?php if($_REQUEST['action']=='view' ){ ?> readonly="" <?php } ?> class="input" style="width:300px;height:35px;"><?php $Fetch['ProductType_Desc'] = (isset($Fetch['ProductType_Desc']) ? $Fetch['ProductType_Desc'] : ''); echo $Fetch['ProductType_Desc']; ?></textarea></td>
</tr>
<tr>
<td height="24" align="right"><span class="feildstxt">Active Status</span></td>
<td height="24" align="center"><span class="feildstxt">:</span></td>
<td height="24" align="left"><input type="checkbox" name="ActiveStatus" id="ActiveStatus" style="width:20px;border:0px;" value="1" autocomplete="off" class="input" <?php $Fetch['Status'] = (isset($Fetch['Status']) ? $Fetch['Status'] : ''); if($Fetch['Status']=='1' || ($_REQUEST['action']!='view' && $_REQUEST['action']!='edit')){ ?> checked="checked"<?php }?> <?php if($_REQUEST['action']=='view')	{ ?> disabled="disabled" <?php } ?>  />
</td>
</tr>
</table>
</td>
...
<option value="ProCategory" <?php $_REQUEST['SearchFilterFieldList'] = (isset($_REQUEST['SearchFilterFieldList']) ? $_REQUEST['SearchFilterFieldList'] : ''); if($_REQUEST['SearchFilterFieldList']=='ProCategory'){ echo 'Selected';} ?> >Product Category</option>
<option value="ProSubCategory" <?php $_REQUEST['SearchFilterFieldList'] = (isset($_REQUEST['SearchFilterFieldList']) ? $_REQUEST['SearchFilterFieldList'] : ''); if($_REQUEST['SearchFilterFieldList']=='ProSubCategory'){ echo 'Selected';} ?> >Product Sub Category</option>
<option value="ProType" <?php $_REQUEST['SearchFilterFieldList'] = (isset($_REQUEST['SearchFilterFieldList']) ? $_REQUEST['SearchFilterFieldList'] : ''); if($_REQUEST['SearchFilterFieldList']=='ProType'){ echo 'Selected'; } ?> >Product Type</option>
